<template>
    ...
    <div class="tab-pane fade show active" id="new-forecast" role="tabpanel" aria-labelledby="new-forecast">
        <div class="row mt-4">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="save" class="ms-4 me-4">
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label" for="forecast-notes">{{ $t('notes') }}</label>
                                <div class="col-lg-9 mb-4">
                                    <textarea class="form-control" id="forecast-notes" rows="3"></textarea>
                                </div>
                            </div>
