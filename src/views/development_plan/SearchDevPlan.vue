<template>
    <div class="tab-pane fade" id="search-dev-plan" role="tabpanel" aria-labelledby="search-dev-plan-tab">
        <div class="row mt-4">
            <div class="card">
                <div class="card-body search-body">
                    <DataTable id="search-dev-plan" class="table table-hover client-search-width">
